...
def load_homepage():
    ...
    return render_template('home.html',username=post_username,bio=post_bio,email=post_email,region=post_region,url_list=url_list,url_profile=url_profile)
...
def recommand():
    ...
    photo_infos = PhotoInfo(username, full_filename, constants.PHOTO_TYPE_INTERESTED,None,None)
    response = crud.update_photo_info(photo_infos)
...
#extract the profile photo, user info, history posts
    ...
    return render_template('home.html',matched=url_list,username=post_username,bio=post_bio,email=post_email,region=post_region,url_list=url_post_list,url_profile=url_profile)
